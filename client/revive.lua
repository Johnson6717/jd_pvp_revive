print("###################################")
print("discord.gg/ljscripts")
print("###################################")
-- Edited By Nico 1997#4637 // https://discord.gg/RAEEP825KC
--- Config ---

local reviveWait = 3 -- Change the amount of time to wait before allowing revive (in seconds).
        ...
        if IsEntityDead(ped) then
            ...
            if IsControlJustReleased(0, 38) and GetLastInputMethod(0) then
                if timerCount <= 0 or cHavePerms then
					...
					TriggerEvent('chat:addMessage', {args = {'Revivete en ' .. timerCount .. ' '}})

                end	
            elseif IsControlJustReleased(0, 86) and GetLastInputMethod( 86 ) then
